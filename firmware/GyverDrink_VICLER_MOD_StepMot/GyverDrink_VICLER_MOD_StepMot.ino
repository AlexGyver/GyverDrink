...
#define STEPPER_HOMING_SPEED 5            // скорость вращения двигателя при движении к концевику (если он есть)
#define STEPER_BACKLASH 3.5               // компенсация мёртвого хода двигателя в градусах. 0 выключает эту функцию
