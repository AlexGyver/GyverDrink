...
void readEEPROM() {
  ...
  if (EEPROM.read(1006) != KEY) {
    EEPROM.write(1006, KEY);
  ...
  if (EEPROM.read(1007) != KEY) {
    EEPROM.write(1007, KEY);
  ...
  if (EEPROM.read(1008) != KEY) {
    EEPROM.write(1008, KEY);
  ...
  if (EEPROM.read(1009) != KEY) {
    EEPROM.write(1009, KEY);
  ...
  if (EEPROM.read(1010) != KEY) {
    EEPROM.write(1010, KEY);
  ...
  if (EEPROM.read(1016) != KEY) {
    EEPROM.write(1016, KEY);
