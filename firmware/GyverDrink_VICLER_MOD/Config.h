...
//#define OLED           1     // 0 для SSD1306(0.96") и SSD1309(1.54" или 2.42"), 1 для SH1106(1.3")
...
// Онлайн конвертер цветов https://bit.ly/34WSaig Используем значения H и S из HSV. // Вычисляем H:(H * 255 / 360). Вычисляем S:(S * 2.55)

#define LEDS_COLOR     20    // цвет подсветки светодиодов от 0 до 255
...
#define MANUAL_MODE_STATUS_COLOR 140, 255 // цвет статусного светодиода в ручном режиме (цвет, насыщенность HS)
#define AUTO_MODE_STATUS_COLOR 100, 255  // цвет статусного светодиода в авто режиме (цвет, насыщенность HS)

/*■■■■■■■■■■■■■■■■■■■■■■■■■■■ Настройки OLED дисплея ■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■*/

#define INVERT_DISPLAY 0     // инверсия цветов OLED дисплея
#define OLED_CONTRAST  20   // яркость дисплея. Макс 255
