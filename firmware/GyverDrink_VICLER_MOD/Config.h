...
#define STEPS_PER_REVOLUTION     2038  // количество шагов на оборот двигателя  2037.88642
#define MICROSTEPS               16    // значение микрошага, выставленного на драйвере двигателя
#define STEPPER_ENDSTOP_INVERT   0     // 1 - высокий сигнал при замыкании, 0 - низкий
#define STEPPER_ACCELERATION     1000  // ускорение двигателя в угол/сек^2
...
#define MOTOR_SPEED    40    // скорость привода. Для серво максимум 100. Для шаговика значение в градус/сек делённое на 10 (т.е. вместо 400градус/сек пишем 40)
...
#define STEPPER_ENDSTOP 1    // сигнал с концевика для двигателя. Закоментировать, если концевик не используется
