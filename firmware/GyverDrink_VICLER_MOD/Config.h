...
// Онлайн конвертер цветов https://bit.ly/34WSaig Используем значение H из HSV. // Вычисляем H:(H * 255 / 360)
...
#define MANUAL_MODE_STATUS_COLOR 140 // цвет статусного светодиода в ручном режиме
